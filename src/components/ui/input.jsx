    ...
    <div className="relative">
      <input
        ...
        className={cn(
          ...
          isMatch === true
            ? "focus-visible:border-green-500 focus-visible:ring-green-500/50" // Green ring for matching passwords
            : isMatch === false
            ? "focus-visible:border-red-500 focus-visible:ring-red-500/50" // Red ring for non-matching passwords
            : "focus-visible:border-ring focus-visible:ring-ring/50", // Default ring
          className
        )}
        value={value}
        onChange={onChange}
